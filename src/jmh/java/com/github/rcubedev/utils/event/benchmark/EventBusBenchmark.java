...
public class EventBusBenchmark {
    ...
    @Setup(Level.Trial)
    public void setup() {
        this.compiledBus = EventBusBuilder.builder(TestEvent.class).recursionGuard(false).global(false).build();
        ...
        this.nonCompiledBusLmf = EventBusBuilder.builder(TestEvent.class).recursionGuard(false).global(false).build();
        ...
        this.nonCompiledBusMH = EventBusBuilder.builder(TestEvent.class).recursionGuard(false).global(false).build();
        ...
        this.callbackBus = EventBusBuilder.builder(TestEvent.class).recursionGuard(false).global(false).build();
