...
public class Test6 {
    public static void main(String[] args) throws NoSuchMethodException, IllegalAccessException {
        ...
        MethodHandle handle = lookup.findStatic(Test6.class, "main", MethodType.methodType(void.class, String[].class));
    ...
    // private record CacheKey(Class<?> ancestor, String methodName, List<Class<?>> params) {
    //     @Override
    //     public @NotNull String toString() {
    //         return ancestor.getName() + "#" + methodName + "(" + params.stream().map(Class::getName).collect(Collectors.joining(", ")) + ")";
    //     }
    // }
}